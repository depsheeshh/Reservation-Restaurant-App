...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('review.index') }}" class="nav-link">Reviews</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('dist/img/user-useran.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
                <a href="{{ route('order_item.index') }}" class="nav-link {{ Request::is('order_item*') ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Order Items</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{{ route('review.index') }}" class="nav-link {{ Request::is('review*') ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Reviews</p>
                </a>
            </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reservation Restaurant</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
